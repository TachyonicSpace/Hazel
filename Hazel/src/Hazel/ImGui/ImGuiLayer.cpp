...
namespace Hazel {
	...
	bool ImGuiLayer::OnKeyTypedEvent(KeyTypedEvent& e)
	{
		...
		if(c > 0 && c < 0x10000)
			io.AddInputCharacter((unsigned char)e.GetKeyCode());
